...
public class Game {
	...
	Text tekst = new Text();
	final private Player player1 = new Player("Bojack Horseman", 1000);
	public Player player2 = new Player("Richie Rich", 1000);
	...
	public void playerTurn(Player p)
	{
		...
		shake.setShake();
		switchens(p);
		p.setBalance(tekst.getFieldValue(shake.getShake()));
		shake.resetShake();
